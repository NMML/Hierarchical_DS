...
#' @author Paul B. Conn
simulate_data_PLoS<-function(S,Observers,misID=1){
	require(mvtnorm)
	#set.seed(122412)
	...
	Conf.param1=c(2,.2,.4,.3,-.1,-.2,-.4,-.8,.5) #parameters for getting it right
	#basically turning misID off with -10 intercept below
	Conf.param2=c(-1,-.2,.2) #parameters for getting an 'unknown'
